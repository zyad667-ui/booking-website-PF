        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-2xl shadow-soft border border-neutral-200 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $stats['total_listings_available'] }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-soft border border-neutral-200 mb-8 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a href="{{ route('bookings.create') }}" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                        <svg class="w-6 h-6 text-purple-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
                        <span class="font-medium text-purple-900">Nouvelle réservation</span>
                    </a>
                    <a href="{{ route('listings.index') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
                        <svg class="w-6 h-6 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                        </svg>
                        <span class="font-medium text-green-900">Rechercher un logement</span>
                    </a>
                    <a href="{{ route('bookings.index') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                        <svg class="w-6 h-6 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 17l4 4 4-4m0-5V3a1 1 0 00-1-1H7a1 1 0 00-1 1v9m12 4h-4m4 0v-4a1 1 0 00-1-1h-4a1 1 0 00-1 1v4m0 0H7m0 0v-4a1 1 0 011-1h4a1 1 0 011 1v4"></path>
                        </svg>
                        <span class="font-medium text-blue-900">Mes réservations</span>
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-soft border border-neutral-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Mes réservations récentes</h3>
                    <div class="space-y-3">
                        @forelse($stats['recent_bookings'] as $booking)
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 flex-1">
                                    <p class="text-sm font-medium text-gray-900">{{ Str::limit($booking->listing->titre, 25) }}</p>
                ...
                <!-- Logements disponibles -->
                <div class="bg-white rounded-2xl shadow-soft border border-neutral-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Logements disponibles</h3>
                    <div class="space-y-3">
