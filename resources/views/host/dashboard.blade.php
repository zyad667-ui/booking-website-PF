<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('home') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-sm font-medium rounded-lg hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white rounded-3xl shadow-2xl mb-8 p-8 relative overflow-hidden">
                <div class="absolute inset-0 bg-black opacity-10"></div>
                <div class="relative z-10">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-2">Bienvenue, {{ auth()->user()->name }} !</h1>
                            <p class="text-green-100 text-lg">Rôles : {{ $roles->implode(', ') }}</p>
                            <p class="text-green-200 mt-2">Gérez vos propriétés et réservations en toute simplicité</p>
                        </div>
                        <div class="text-right">
                            <div class="bg-white bg-opacity-20 rounded-2xl p-4 backdrop-blur-sm">
                                <p class="text-sm text-green-200">Dernière connexion</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xs text-green-600 font-medium">{{ $stats['published_listings'] }} publiées</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-3xl font-bold text-gray-900">{{ $stats['pending_listings'] }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 mb-8 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <a href="{{ route('listings.create') }}" class="group flex items-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl hover:from-green-100 hover:to-green-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        ...
                        <div>
                            <span class="font-semibold text-green-900 text-lg">Nouvelle annonce</span>
                            <p class="text-green-700 text-sm">Créer une propriété</p>
                        </div>
                    </a>
                    
                    <a href="{{ route('listings.index') }}" class="group flex items-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl hover:from-blue-100 hover:to-blue-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        ...
                        <div>
                            <span class="font-semibold text-blue-900 text-lg">Gérer mes annonces</span>
                            <p class="text-blue-700 text-sm">Modifier les propriétés</p>
                        </div>
                    </a>
                    
                    <a href="{{ route('bookings.index') }}" class="group flex items-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl hover:from-purple-100 hover:to-purple-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        ...
                        <div>
                            <span class="font-semibold text-purple-900 text-lg">Voir les réservations</span>
                            <p class="text-purple-700 text-sm">Gérer les demandes</p>
                        </div>
                    </a>
                </div>
            </div>
