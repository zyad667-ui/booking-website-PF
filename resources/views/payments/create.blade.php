...
@section('title', 'Paiement - PlaceZo')
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <div class="mb-6">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        <h3 class="font-medium text-gray-900 mb-2">Résumé de la réservation</h3>
                        <div class="space-y-2 text-sm text-gray-600">
                            ...
                            <div class="flex justify-between">
                                <span>Arrivée:</span>
                                <span>{{ \Carbon\Carbon::parse($booking->date_arrivee)->format('d/m/Y') }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span>Départ:</span>
                                <span>{{ \Carbon\Carbon::parse($booking->date_depart)->format('d/m/Y') }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span>Voyageurs:</span>
                                <span>{{ $booking->nombre_voyageurs }} personne(s)</span>
                            </div>
                            <div class="flex justify-between font-semibold text-gray-900 border-t pt-2">
                                <span>Total:</span>
                                <span>{{ number_format($booking->montant_total, 2) }} €</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <button id="submit-payment" class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-6 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed">
                        <span id="button-text">Payer {{ number_format($booking->montant_total, 2) }} €</span>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Support 24/7</p>
                        </div>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        Notre équipe est disponible pour vous aider avec votre réservation.
                    </p>
                    <a href="#" class="text-blue-600 hover:text-blue-700 text-sm font-medium">Contactez-nous</a>
                </div>
